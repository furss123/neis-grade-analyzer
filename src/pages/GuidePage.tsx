  ...
  return (
    <main className="narrow-page">
      ...
      <div className="steps">
        ...
        <Guide number="02" title="담임 · 전과목 성적 일람표" path="성적 → 성적조회/통계 → 학기말성적조회 → 전과목 성적 일람표" note="지필평가와 수행평가 점수가 함께 포함되며 학기 전체·학기말 종합 분석에 사용합니다." />
        <Guide number="03" title="교과 · 시험과 수행평가" path="성적 → 성적조회/통계 → 학기말성적조회 → 지필/수행 성적일람표" note="받은점수 기준과 환산점 기준을 모두 지원합니다." />
        <Guide number="04" title="교과 · 특정 시험" path="성적 → 지필평가조회/통계 → 지필평가조회 → 교과목별 일람표 조회" note="교과목별 또는 강의실별 유형을 선택합니다." />
      </div>
